        ...
        schema: {
            ...
            properties: {
                'context-decison-letter': {
                    ...
                    <h2 class="govuk-heading-l">What you should do</h2>
                    ...
                    <h2 class="govuk-heading-l">Why you are not eligible</h2>
                    ...
                    <h3 class="govuk-heading-s">Scheme rules which affect your eligibility to receive an award</h3>
                    ...
                    <h2 class="govuk-heading-l">Ask for a review</h2>
                    ...
                    <section class="moj-ticket-panel__content moj-ticket-panel__content--blue" aria-label="Section 1">
                        ...
                        <p class="govuk-body"><a class="govuk-link" href="" target="_blank">Download as PDF</a></p>     
                        <p class="govuk-body"><a class="govuk-link" href="" target="_blank">Download as an accessible web page (HTML, )</a></p>                     
                        <p class="govuk-body"><a class="govuk-link" href="javascript:window.print()">Print this page</a></p>                       
                    </section>
                    </article>
                    <h3 class="govuk-heading-m govuk-!-margin-bottom-0">More information</h3>
                    <p class="govuk-body"><a href="https://www.gov.uk/guidance/criminal-injuries-compensation-a-guide" target="_blank" class="govuk-link">Read our guide to the Criminal Injuries Compensation Scheme (opens in a new tab)<a>.</p>
                    <h3 class="govuk-heading-m govuk-!-margin-bottom-0">Contact us</h3>
                    <p class="govuk-body"><a href="https://contact-the-cica.form.service.justice.gov.uk/" target="_blank" class="govuk-link">Contact us if you have any queries (opens in a new tab)<a>.</p>
                    `,
                },
            },
            examples: [{}],
